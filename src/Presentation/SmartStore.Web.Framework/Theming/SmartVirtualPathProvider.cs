...
namespace SmartStore.Web.Framework.Theming
{
    public abstract class SmartVirtualPathProvider : VirtualPathProvider
    {
        ...
        {
            _isDebug = /* Added by CTA: TODO: Replace HttpContext.Current with dependency injection pattern using IHttpContextAccessor. */
HttpContext.Current.IsDebuggingEnabled && CommonHelper.IsDevEnvironment;
        }
