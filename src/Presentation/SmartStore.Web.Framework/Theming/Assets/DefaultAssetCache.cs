...
namespace SmartStore.Web.Framework.Theming.Assets
{
    public class DefaultAssetCache : IAssetCache
    {
            ...
            ICommonServices services)
        {
            ...
            _isEnabled = _themeSettings.AssetCachingEnabled == 2 || (_themeSettings.AssetCachingEnabled == 0 && !/* Added by CTA: TODO: Replace HttpContext.Current with dependency injection pattern using IHttpContextAccessor. */
