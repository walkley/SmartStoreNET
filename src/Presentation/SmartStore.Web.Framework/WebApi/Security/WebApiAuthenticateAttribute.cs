...
namespace SmartStore.Web.Framework.WebApi.Security
{
    ...
    public class WebApiAuthenticateAttribute : System.Web.Http.AuthorizeAttribute
    {
            ...
            out Customer customer)
        {
            ...
            var request = /* Added by CTA: TODO: Replace HttpContext.Current with dependency injection pattern using IHttpContextAccessor. */
...
HttpContext.Current.User = new SmartStorePrincipal(customer, HmacAuthentication.Scheme1);
                ...
                var response = /* Added by CTA: TODO: Replace HttpContext.Current with dependency injection pattern using IHttpContextAccessor. */
